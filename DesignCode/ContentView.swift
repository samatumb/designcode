...
//  DesignCode
//
//  Created by Samat on 25.05.2020.
    ...
    var body: some View {
        VStack(spacing: 20) {
            Rectangle()
                ...
                .cornerRadius(3)
                .opacity(0.1)
            Text("This certificate is proof that Samat Umirbekov has achieved the UI Design course with approval from a Design+Code instructor.")
